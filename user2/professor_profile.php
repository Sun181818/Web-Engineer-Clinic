...
$stmt = $db->prepare("SELECT * FROM professor WHERE pid = '{$_GET['pid']}' limit 1");
...
//user
$sql_u = "SELECT * FROM user where uid = '$dbuid'";
                                ...
                                <div class="modal-content">
                                  ...
                                  <form action="profile_edit.php" method="post">
                                    <div class="modal-body">
                                      ...
                                      <div class="form-group">
                                        <label for="expert" class="col-form-label">Convenient date and time: </label>
                                      ...
                                      <!-- <div class="form-group">
                                          ...
                                          <div class="form-group">
                                        <label for="expert" class="col-form-label">:</label>
                                        <input type="text" class="form-control" name="expert" value="<?php echo $dbexpert; ?>">
                                      </div>
